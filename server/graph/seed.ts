...
const HISTORICAL_APPROVAL_EXPLANATION_SNAPSHOT = JSON.stringify({
  capturedAt: "2026-08-27T00:05:00.000Z",
  decision: {
    actionRequestId: "request-historical-approved-refund",
    actionTypeId: "action-issue-refund",
    amount: 750,
    reasonCode: "POLICY_APPROVAL_REQUIRED",
    reasons: ["Enterprise refunds from 500 to 999 require finance approval."],
    verdict: "APPROVAL_REQUIRED",
  },
  formatVersion: 1,
  orderedNodes: [
    { id: "agent-billing-assistant", label: "Agent", name: "Billing Assistant" },
    { id: "user-maya-finance", label: "User", name: "Maya Finance" },
    { id: "role-billing-operator", label: "Role", name: "Billing Operator" },
    { id: "permission-issue-refund", label: "Permission", name: "Issue Refund Permission" },
    { id: "action-issue-refund", label: "ActionType", name: "Issue Refund" },
    { id: "resource-invoice-1844", label: "Resource", name: "Invoice #1844" },
    { id: "customer-acme", label: "Customer", name: "Acme Corporation" },
    { id: "tier-enterprise", label: "Tier", name: "Enterprise" },
    { id: "policy-approval-enterprise-refund", label: "Policy", name: "Enterprise Refund Approval" },
  ],
  policy: {
  ...
  relationships: [
    { from: { id: "agent-billing-assistant", label: "Agent", name: "Billing Assistant" }, relationship: "OPERATED_BY", to: { id: "user-maya-finance", label: "User", name: "Maya Finance" } },
    { from: { id: "user-maya-finance", label: "User", name: "Maya Finance" }, relationship: "HAS_ROLE", to: { id: "role-billing-operator", label: "Role", name: "Billing Operator" } },
    { from: { id: "role-billing-operator", label: "Role", name: "Billing Operator" }, relationship: "GRANTS", to: { id: "permission-issue-refund", label: "Permission", name: "Issue Refund Permission" } },
    { from: { id: "permission-issue-refund", label: "Permission", name: "Issue Refund Permission" }, relationship: "ALLOWS", to: { id: "action-issue-refund", label: "ActionType", name: "Issue Refund" } },
    { from: { id: "resource-invoice-1844", label: "Resource", name: "Invoice #1844" }, relationship: "BELONGS_TO", to: { id: "customer-acme", label: "Customer", name: "Acme Corporation" } },
    { from: { id: "customer-acme", label: "Customer", name: "Acme Corporation" }, relationship: "HAS_TIER", to: { id: "tier-enterprise", label: "Tier", name: "Enterprise" } },
    { from: { id: "policy-approval-enterprise-refund", label: "Policy", name: "Enterprise Refund Approval" }, relationship: "GOVERNS", to: { id: "action-issue-refund", label: "ActionType", name: "Issue Refund" } },
    { from: { id: "policy-approval-enterprise-refund", label: "Policy", name: "Enterprise Refund Approval" }, relationship: "TARGETS", to: { id: "tier-enterprise", label: "Tier", name: "Enterprise" } },
    { from: { id: "policy-approval-enterprise-refund", label: "Policy", name: "Enterprise Refund Approval" }, relationship: "REQUIRES_ROLE", to: { id: "role-finance-manager", label: "Role", name: "Finance Manager" } },
  ],
  requiredApprovalRole: { id: "role-finance-manager", label: "Role", name: "Finance Manager" },
});
...
const SEEDED_NODES: Record<NodeLabel, ReadonlyArray<SeedProperties>> = {
  ...
  Policy: [
    ...
    },
    {
      ...
      maxAmount: null,
      minAmount: 0,
      name: "Enterprise Export Approval",
  ...
  Evidence: [
    {
      ...
      explanationSnapshotJson: HISTORICAL_APPROVAL_EXPLANATION_SNAPSHOT,
      policyId: "policy-approval-enterprise-refund",
      policyVersion: 1,
